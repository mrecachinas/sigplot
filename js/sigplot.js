...
import Layer2DSDS from "./sigplot.layer2dSDS.js";
import Plugin from "./sigplot.plugin.js";
import AccordionPlugin from "./sigplot.accordion.js";
import AnnotationPlugin from "./sigplot.annotations.js";
...
Plot.prototype = {
    ...
    hide_spinner: function(force) {
        var cnt_pending = Object.values(this._Gx.HCB_UUID).filter(function(v) { return v === null; }).length;
